...
<body class="page-template page-template-page-templates page-template-template-default page-template-page-templatestemplate-default-php page page-id-1053 elementor-default elementor-kit-8 elementor-page elementor-page-1053">
...
<div class="template-home-wrapper">
	...
	<div class="page-content-home-page">										
			...
			<div class=" blog_style_adn_2">				
				<div class="blog_wrap brand_carousel owl-loaded owl-carousel curosel-style">
