            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 txtc  text-center ccase">
                            ...
                            <ul><li><a href="/">Home</a></li><li><i class="fa fa-angle-right"></i></li><li>Our Products</li></ul>
                                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row align-items-center" style="margin-top: -130px">
                                <div class="col-lg-6">
                                    <div class="rv-video-section">
                                        ...
                                        <div class="item aos-init aos-animate" data-aos="fade-left">
                                    ...
                                    <div class="faq-custom-col">
                                        <div class="section-title-wrap">
                                            <div class="item aos-init aos-animate" data-aos="fade-right">
                                                ...
                                                <h6 class="section-sub-title mt-10">Our Solutions</h6>
                                                <h3 class="heading">NEXCOM <br>  </h3>
                                                ...
                                                <div class="itsoft-custom-buttons one">
                                                    <div class="itsoft-button"><a href="https://www.nexcom.ke/">Discover More<i class="fa fa-angle-right"></i></a></div>		</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
