<div class="em40_header_area_main">
  ...
  <div class="mobile_logo_area d-sm-block d-md-block d-lg-none">
    ...
    <!-- START HEADER MAIN MENU AREA -->
      ...
      <!-- HEADER TRANSPARENT MENU -->
          <div class="itsoft-main-menu one_page menu4 d-md-none d-lg-block d-sm-none d-none tr-black-menu scroll-to-fixed-fixed" style="z-index: 1000; position: fixed; top: 0px; margin-left: 0px; width: 1585px; left: 0px;">
          ...
          <div class="logo">
              <a class="main_sticky_main_l standard-logo" href="/" title="IT-Soft">
                  <img src="{{ asset('img/logo.png') }}" alt="IT-Soft">
              </a>
              <a class="main_sticky_l" href="/" title="IT-Soft">
                  <img src="{{ asset('img/logo.png') }}" alt="IT-Soft">
              </a>			
          </div>	  
  ...
  <li id="menu-item-1516" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1516"><a href="/contact_us">Contact Us </a></li>
      ...
      </div><div style="display: block; width: 1585px; height: 0px; float: none;"></div>	
